  ...
  return (
    ...
    >
      {AFrameData && (
        <a-scene
          embedded
          environment="preset: japan; ground: canyon; groundTexture: checkerboard; groundColor: #2b291c; groundColor2: #312f20; dressingColor: #124017; dressing: trees"
        ...
        >
          ...
          <a-assets timeout="5000">
            {/* <a-asset-item
              id={Object.keys(AFrameData?.properties_3D).find(
                (key) => key == "skybox"
              )}
