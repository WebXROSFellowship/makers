...
var router = __webpack_require__(599);
...
function createBrowserRouter(routes, opts) {
  return (0,router/* createRouter */.p7)({
    basename: opts == null ? void 0 : opts.basename,
    future: _extends({}, opts == null ? void 0 : opts.future, {
      v7_prependBasename: true
    }),
    history: (0,router/* createBrowserHistory */.lX)({
      window: opts == null ? void 0 : opts.window
    }),
    hydrationData: (opts == null ? void 0 : opts.hydrationData) || parseHydrationData(),
    routes,
    mapRouteProperties: dist/* UNSAFE_mapRouteProperties */.us
  }).initialize();
}
...
function deserializeErrors(errors) {
  ...
  for (let [key, val] of entries) {
    ...
    if (val && val.__type === "RouteErrorResponse") {
      serialized[key] = new router/* ErrorResponse */.iQ(val.status, val.statusText, val.data, val.internal === true);
...
const Link = /*#__PURE__*/react.forwardRef(function LinkWithRef(_ref4, ref) {
  ...
  let {
    basename
  } = react.useContext(dist/* UNSAFE_NavigationContext */.Us); // Rendered into <a href> for absolute URLs
...
const Home = () => {
  return /*#__PURE__*/react.createElement(react.Fragment, null, /*#__PURE__*/react.createElement(dist/* Outlet */.j3, null));
};
...
const App = () => {
  ...
  return /*#__PURE__*/react.createElement(DataContext/* default.Provider */.Z.Provider, {
    value: {
      lang: lang,
      setLang: setLang
    }
  }, /*#__PURE__*/react.createElement(MenuDataContext/* default.Provider */.Z.Provider, {
    value: {
      menuData,
      setMenuData
    }
...
/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(829);
