"use strict";
(self["webpackChunkmakers"] = self["webpackChunkmakers"] || []).push([[201],{
...
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(818);
...
var Navbar = function Navbar() {
  ...
  function _fetchMenuData() {
    _fetchMenuData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var stagingData, jsonData, items;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("https://staging.webxr.link/wp-json/wp/v2/menus?menus");
          case 3:
            stagingData = _context.sent;
            _context.next = 6;
            return stagingData.json();
          case 6:
  ...
  function setMenuData(items) {
    var head = items.filter(function (e) {
      return e.menu_item_parent === "0";
    })[0];
    var childItems = items.filter(function (e) {
      return parseInt(e.menu_item_parent) === head.ID;
    });
    var nestedItems = [];
    var currIDs = [];
    var _loop = function _loop() {
      var currChild = childItems[i];
      var allNestedChild = items.filter(function (e) {
        return parseInt(e.menu_item_parent) === currChild.ID;
      });
      if (allNestedChild.length > 0) {
        currIDs.push(currChild.ID);
        allNestedChild.map(function (ele) {
          return nestedItems.push(ele);
        });
      }
    };
  ...
  function printElem(element, indent, data) {
    ...
    var children = data.filter(function (e) {
      return e.menu_item_parent == element.ID;
    });
  ...
  }, "The Polys WebXR Awards and Summit Series"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "navbar-right"
  }, navbarMenus ? navbarMenus.map(function (currEle, i) {
    var head = currEle.head,
      childItems = currEle.childItems,
      nestedItems = currEle.nestedItems;
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      className: "dropdown",
      key: i
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
      className: "dropbtn"
    }, head.title), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
      className: "dropdown__content"
    }, childItems.map(function (menu, i) {
      var c = c2IDs.includes(menu.ID);
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__.Link, {
        ...
        to: menu.url
      }, menu.title, c && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", {
        className: "n2-drop"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("i", {
        className: "fa-solid fa-circle-chevron-down"
      })), c && hoveredIndex === i && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
        className: "n2"
      }, nestedItems.map(function (cur, i) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_router_dom__WEBPACK_IMPORTED_MODULE_1__.Link, {
          to: cur.url,
  ...
  }))), showMenu === true ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "sideMenu"
  }, navbarMenus ? navbarMenus.map(function (currEle, i) {
    var head = currEle.head,
      childItems = currEle.childItems,
  ...
  }) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null)) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null))));
};
