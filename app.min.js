...
const Footer = () => {
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "h6"
  }, "\xA9 Copyright by ", " ", /*#__PURE__*/react.createElement(dist_Link, {
    to: "/",
...
const Header = () => {
  ...
  return /*#__PURE__*/React.createElement("nav", {
    ...
    className: "navbar-right"
  }, mainMenus === null || mainMenus === void 0 ? void 0 : mainMenus.map((menusItem, index) => {
    let parnetMenuID = menusItem === null || menusItem === void 0 ? void 0 : menusItem.menu_item_parent;
    return /*#__PURE__*/React.createElement("div", {
      className: "dropdown",
      key: index
    }, parnetMenuID === "0" && /*#__PURE__*/React.createElement(Link, {
      to: menusItem === null || menusItem === void 0 ? void 0 : menusItem.url
    }, /*#__PURE__*/React.createElement("button", {
      className: "dropbtn"
    }, menusItem === null || menusItem === void 0 ? void 0 : menusItem.title)), (menusItem === null || menusItem === void 0 ? void 0 : menusItem.ID) == parnetMenuID && /*#__PURE__*/React.createElement("div", {
      className: "dropdown__content"
    }, /*#__PURE__*/React.createElement(Link, {
      className: "dropdown__items",
      to: url
...
const Body = () => {
  ...
  }, loading ? /*#__PURE__*/react.createElement(loader_AppLoader, null) : /*#__PURE__*/react.createElement("div", null, data ? /*#__PURE__*/react.createElement("div", null, data !== null && data !== void 0 && (_data$properties_3D = data.properties_3D) !== null && _data$properties_3D !== void 0 && _data$properties_3D.use_aframe ? /*#__PURE__*/react.createElement(aframe_AFrame, {
    aframeData: data
  }) : /*#__PURE__*/react.createElement("div", {
    className: "content"
  }, /*#__PURE__*/react.createElement("h1", {
    dangerouslySetInnerHTML: {
      __html: data === null || data === void 0 ? void 0 : (_data$title = data.title) === null || _data$title === void 0 ? void 0 : _data$title.rendered
    }
...
const Posts = () => {
  ...
  const fetchdata = async () => {
    ...
    await fetch(url).then(response => response.json()).then(result => {
      ...
      menuData.map(item => {
        var _item$items;
        item === null || item === void 0 ? void 0 : (_item$items = item.items) === null || _item$items === void 0 ? void 0 : _item$items.filter(childItem => {
          if ((childItem === null || childItem === void 0 ? void 0 : childItem.object) == "post") {
      ...
      result.map(postData => {
        var _postData$properties_;
        // console.log("page ", postData?.slug);
        if (!(postData !== null && postData !== void 0 && (_postData$properties_ = postData.properties_3D) !== null && _postData$properties_ !== void 0 && _postData$properties_.use_aframe)) {
          // console.log("page data without Aframe...", postData);
          menus.map(item => {
            if ((item === null || item === void 0 ? void 0 : item.url) === curl) {
...
/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(209);
